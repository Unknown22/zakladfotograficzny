...
--
-- Host: 127.0.0.1
-- Czas generowania: 02 Kwi 2016, 13:25
...
CREATE TABLE `order` (
  ...
  `last_edit_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
...
INSERT INTO `order` (`id_order`, `id_status`, `creation_time`, `last_edit_time`, `adding_information`, `id_payment`, `id_shippment`, `id_department`) VALUES
(1, 1, '2016-04-02 09:55:34', '2016-04-02 09:55:34', 'Dodatkowe informacje testowe...', 1, 1, 0),
(2, 1, '2016-04-02 10:24:35', '2016-04-02 10:24:35', 'Tescik...', 1, 1, 0),
(3, 1, '2016-04-02 10:24:47', '2016-04-02 10:24:47', 'Tescik2...', 1, 1, 0),
(4, 1, '2016-04-02 10:26:44', '2016-04-02 10:26:44', 'Tescik2...', 1, 1, 0);
...
INSERT INTO `order_status` (`id_status`, `type_of_status`) VALUES
(1, 'Stworzony');
...
INSERT INTO `payment` (`id_payment`, `type_of_payment`, `price`) VALUES
(1, 'Przelew', 5);
...
INSERT INTO `shipment` (`id_shipment`, `type_of_shipment`, `price`) VALUES
(1, 'Kurier', 14);
...
--
ALTER TABLE `shipment`
  MODIFY `id_shipment` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
